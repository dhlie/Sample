...
import com.dhl.base.utils.UIUtil;
...
public class TitleBar extends FrameLayout {
	...
	public TitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
			mTopMargin = UIUtil.Companion.getStatusBarHeight(context);
		}
	...
	private void addLeftButton(Drawable drawable, String text) {
		...
		if (mLeftView != null) {
			mLeftView.setBackgroundResource(R.drawable.bg_selectable_action_button);
	...
	private void addRightButton(Drawable fDrawable, String fText, Drawable sDrawable, String sText, Drawable tDrawable, String tText) {
		...
		if (firstView != null) {
			btnCount++;
			firstView.setBackgroundResource(R.drawable.bg_selectable_action_button);
		...
		if (secondView != null) {
			btnCount++;
			secondView.setBackgroundResource(R.drawable.bg_selectable_action_button);
		...
		if (thirdView != null) {
			btnCount++;
			thirdView.setBackgroundResource(R.drawable.bg_selectable_action_button);
