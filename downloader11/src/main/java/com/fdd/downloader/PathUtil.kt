...
internal class PathUtil private constructor(){
    companion object {
         ...
         */
        private var defaultDownloadDir: String = getContext().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS)?.absolutePath ?: getContext().getExternalFilesDir(null)!!.absolutePath
