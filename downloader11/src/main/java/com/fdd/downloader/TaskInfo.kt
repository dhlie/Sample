...
import com.fdd.downloader.TaskInfo.Companion.COLUMN_FILE_ID
 ...
 *
 */
@Entity(tableName = DownloadDatabase.TABLE_TASK, indices = [Index(value = [COLUMN_FILE_ID], unique = true)])
class TaskInfo {
    ...
    @ColumnInfo(name = COLUMN_FILE_ID)
    var fileId: String = ""                         //文件唯一 id
