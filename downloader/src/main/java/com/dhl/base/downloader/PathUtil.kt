...
import com.dhl.base.utils.FileSystem
...
internal class PathUtil private constructor(){
    companion object {
         ...
         */
        private var defaultDownloadDir: String = ContextHolder.appContext.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS)?.absolutePath ?: ContextHolder.appContext.getExternalFilesDir(null)!!.absolutePath
